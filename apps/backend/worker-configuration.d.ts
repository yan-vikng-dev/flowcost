/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv` (hash: 4a69d3297851d4250331ab9ec33b581f)
// Runtime types generated with workerd@1.20251213.0 2025-11-17 global_fetch_private_origin,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AgentServer" | "NotificationScheduler";
	}
	interface Env {
		CACHE: KVNamespace;
		POSTHOG_HOST: "https://eu.i.posthog.com";
		POSTHOG_KEY: "phc_h0VnQKH9G4gf7a1qTVSriK4zcQHp9BXmYQElEz6cYD4";
		...
		AI_CONVERSATION_SERVER: DurableObjectNamespace<import("./src/index").AgentServer>;
		NOTIFICATION_SCHEDULER: DurableObjectNamespace<import("./src/index").NotificationScheduler>;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POSTHOG_HOST" | "POSTHOG_KEY" | "EXCHANGE_RATE_API_KEY" | "GEMINI_API_KEY" | "WHATSAPP_WEBHOOK_SECRET" | "WHATSAPP_ACCESS_TOKEN" | "WHATSAPP_APP_SECRET" | "WHATSAPP_PHONE_NUMBER_ID" | "WHATSAPP_BUSINESS_ACCOUNT_ID" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_OBSERVABILITY_TOKEN">> {}
}
