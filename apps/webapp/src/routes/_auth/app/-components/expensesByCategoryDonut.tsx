...
export function ExpensesByCategoryDonut() {
  ...
  const LABEL_H_GAP = 16; // padding inside donut for text
    ...
    <Card className="flex flex-col">
        ...
        {isEmpty ? (
          <div className="mx-auto grid h-[300px] w-full place-items-center">
            <div className="text-center text-sm">
              ...
              <div className="text-muted-foreground">Add an expense to see the breakdown</div>
            </div>
          </div>
        ) : (
          <ChartContainer
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        ...
        <div className="text-muted-foreground leading-none">
          Showing current month total expenses in display currency
        </div>
      </CardFooter>
    </Card>
  );
...
function CenterLabel({
  ...
  React.useLayoutEffect(() => {
    ...
    try {
      ...
      // getBBox can fail if not attached yet; ignore
    }
  }, [symbol, total, innerRadius, hPad, signPrefix]);
