...
function FieldLabel({
	...
	return (
		<Label
			className={cn(
				"group/field-label peer/field-label flex w-fit gap-2 pl-1 leading-snug group-data-[disabled=true]/field:opacity-50",
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
	return (
		<p
			className={cn(
				"font-normal text-muted-foreground text-sm leading-normal group-has-data-[[data-orientation=horizontal]]/field:text-balance",
