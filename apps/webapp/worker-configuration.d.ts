/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 963ad1a446245c5edcae7ed5db0c8a8b)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_ONBOARDING_ENABLED: string;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "WHATSAPP_E164" | "BACKEND_URL" | "POSTHOG_HOST" | "VITE_GTAG_ID" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_SECRET" | "VITE_POSTHOG_KEY" | "VITE_ONBOARDING_ENABLED">> {}
}
