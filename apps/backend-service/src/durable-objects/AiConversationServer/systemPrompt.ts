...
export const buildSystemPrompt = (context: MessageContext): string => {
	...
	const basePrompt = [
		...
		"When creating an entry, the tool will return the creation result, as well as the converted amount in the user's preferred display currency. You should report back to the user using both values.",
