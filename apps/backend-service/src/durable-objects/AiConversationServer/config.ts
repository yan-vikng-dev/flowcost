...
export const getSystemMessage = (): ModelMessage => {
	return {
		...
		content:
			...
			"CRITICAL: After executing any tool, you MUST always provide a concise summary of what was done. Never return empty text after tool execution. The summary should confirm the action taken and the outcome.\n" +
			...
			"Should the developer ask you about the current agent version, it's currently: " +
			AGENT_VERSION,
	}
}
