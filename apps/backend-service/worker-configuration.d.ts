/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv` (hash: d6229e6e0f1b65eb756881a8e2c9c15e)
// Runtime types generated with workerd@1.20251213.0 2025-04-01 global_fetch_private_origin,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AiConversationServer" | "NotificationScheduler";
	}
	interface Env {
		CACHE: KVNamespace;
		...
		AI_CONVERSATION_SERVER: DurableObjectNamespace<import("./src/index").AiConversationServer>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POSTHOG_HOST" | "POSTHOG_KEY" | "EXCHANGE_RATE_API_KEY" | "GEMINI_API_KEY" | "WHATSAPP_WEBHOOK_SECRET" | "WHATSAPP_ACCESS_TOKEN" | "WHATSAPP_APP_SECRET" | "WHATSAPP_PHONE_NUMBER_ID">> {}
}
