...
const CookieConsent = React.forwardRef<HTMLDivElement, CookieConsentProps>(
  (
    ...
    // Build inline-linked description when phrase "cookie policy" exists
    const cookiePolicyRegex = /cookie policy/i;
    const hasInlinePolicyLink =
      typeof description === "string" && cookiePolicyRegex.test(description) && !!learnMoreHref;
    const renderedDescription: React.ReactNode =
      typeof description === "string" && learnMoreHref && cookiePolicyRegex.test(description)
        ? (() => {
            const lower = description.toLowerCase();
            const phrase = "cookie policy";
